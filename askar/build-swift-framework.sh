...
WRAPPER_PATH="../swift/Sources/Askar"
...
cargo run --bin uniffi-bindgen generate uniffi/askar.udl --language swift -o $OUT_PATH --lib-file ./target/$CURRENT_ARCH/release/$LIBRARY_NAME
