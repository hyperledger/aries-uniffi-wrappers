...
final class CryptoTests: XCTestCase {
    ...
    func testCryptoBoxSeal() throws {
        ...
        let dec = try crypto.boxSealOpen(receiverKey: key, ciphertext: enc)
    ...
    func testCryptoBox() throws {
        ...
        let enc = try crypto.cryptoBox(receiverKey: receiverKey, senderKey: senderKey, message: message, nonce: nonce)
